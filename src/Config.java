public class Config {
    public static int ONE_MINUTE = 600;  //真实世界的一分钟与程序中的一分钟的毫秒数关系

    public static int ELEVATO_SPEED = ONE_MINUTE / 20; //电梯运行速度
    public static int POP_PUSH_SPEED = ONE_MINUTE / 10; //上下一个人所需的时间

    public static int MAX_MINTUES = 20; //最大分钟
    public static int HIGH_VALUE = 20;  //每分钟人数峰值
